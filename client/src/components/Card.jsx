...
function Card({ realization, onView, onAddToChat }) {
    ...
    return (
        <div className="realization-card" onClick={handleCardClick} style={{ cursor: "pointer" }}>
            ...
            <div className={"fc ai-c jc-c o0-5"} style={{position:"absolute", right:"1rem", top:"1rem", border:'1px solid white',zIndex:'4', borderRadius:'5rem',width:"1.6rem", height:"1.6rem"}}>
